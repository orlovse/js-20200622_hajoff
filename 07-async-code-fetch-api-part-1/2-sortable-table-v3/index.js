...
export default class SortableTable {
    ...
    onWindowScroll = async () => {
      const { bottom } = this.element.getBoundingClientReact();
      const { id, order } = this.stored;

      if (bottom < document.documentElement.clientHeight && !this.loading && !this.isSirtLocally) {
        this.start = this.end;
        this.end = this.start + this.step;

        timingSafeEqual.loading = true;
